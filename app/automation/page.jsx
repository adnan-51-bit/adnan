...
<nav><a href="/zentral">Master-Zentrale</a><a href="/e-commerce">E-Commerce</a><a href="/produkt-pipeline">Produkt-Pipeline</a><a href="/start">Start</a><a href="/zentral">Zentrale</a></nav>
...
<section className="panel"><span className="eyebrow">ENGINE-STATUS</span><h2>🟡 Scaffold aktiv · externe Anschlüsse offen</h2><p className="engine">Die Kernlogik für Events, Zustandswechsel und Sicherheits-Gates ist im Repository vorhanden. Echte Zahlungen, Bestellungen und Lieferantenaufträge werden bewusst noch nicht ausgelöst.</p></section><section className="panel"><span className="eyebrow">SELF-TEST</span><h2>Technische Automationslogik prüfen</h2><button className="test" onClick={runSelfTest}>Self-Test starten</button>{test && <pre>{typeof test === "string" ? test : JSON.stringify(test,null,2)}</pre>}</section><section className="panel"><span className="eyebrow">AUTOMATISIERBAR</span><h2>🟢</h2><ul><li>Produktstatus und Quality-Gates</li><li>Kosten- und Margenberechnung</li><li>Bestellstatus und Tracking</li><li>Aufgaben und Fehlerstatus</li><li>Benachrichtigungen</li><li>Reporting und Tagesübersicht</li><li>Technische Build-/CI-Prüfung</li></ul></section>
