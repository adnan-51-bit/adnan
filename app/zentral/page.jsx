  ...
  return (
    <main className="shell">
      ...
      <nav className="nav">
        ...
        <a href="/master">Master Dashboard</a><a href="/">Anfragen</a>
        <a href="/e-commerce">E-Commerce</a><a href="/kunden-gewinnen">Kunden gewinnen</a><a href="/start">Start</a><a href="/automation">Automationen</a>
