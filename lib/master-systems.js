...
async function computeAutoOverlay(){
  ...
  return {
    ...
    supabase: supabaseConfigured
      ? { status:"🟡", note:"SUPABASE_URL/SUPABASE_SECRET_KEY gesetzt, echter Verbindungstest steht noch aus", next_action:"Schema-Deployment + Read/Write-Smoke-Test" }
      : { status:"🔵", note:"Kein Supabase-Konto vorhanden (bewusst nicht selbst angelegt)", next_action:"Wartet auf Adnans Entscheidung" },
