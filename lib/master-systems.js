...
const seed = [
  ...
  // Reparaturphase Easybell (26.09.2026): Easybell hat im Code keinerlei Schnittstelle (nur SIP-Trunk-
  // Konfiguration im Easybell-/Famulor-Konto) - nichts wird hier simuliert. Externe, offene Integration.
  {id:"easybell",name:"Easybell",status:"🔵",note:"Externe Integration ohne Schnittstelle: nur SIP-Trunk (Easybell → Famulor), kein API-Zugriff, kein Live-Status möglich",last_checked_at:null,next_action:"Weiterleitung nur per echtem Testanruf prüfbar (Easybell-Kundenportal)",source:"manual"},
